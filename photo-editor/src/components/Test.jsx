  ...
  return (
    <div className="home">
      <div className="editor">
        ...
        <div className="boka" style={{width:"100%"}}>
          <div className="photo-full" ref={exportRef} style={{ boxShadow: imageStyle.boxShadow, backgroundColor: bg }} >
            {!imageSrc&&<>
...
/>
      ...
      <Button variant="contained"  color="secondary" onClick={() => exportAsImage(exportRef.current, "test")}>Capture</Button>
        </div>   
  );
}